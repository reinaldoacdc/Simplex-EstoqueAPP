...
uses
  ...
  FMX.ListView.Adapters.Base, Form.Estoque;
...
procedure TDatasetFrame.ListView1Click(Sender: TObject);
begin
  Self.Hide;
  frmEstoque.Fprod := frmEstoque.cdsProdutosCODIGO_PRODUTO.AsInteger;
  frmEstoque.FrameStand1.HideAndCloseAll();
  frmEstoque.LoadFromFrame;
end;
